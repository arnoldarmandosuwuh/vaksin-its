    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h5 class="tx-montserrat tx-medium" id="tambahjenisvaksinLabel">Tambah Vaksinator</h5>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content tx-14 bg-white">
        ...
        <div class="modal-footer bd-t-0">
          <form action="{{ route('vaksinator.destroy', 'id') }}" method="POST">
            @method('DELETE')
            @csrf

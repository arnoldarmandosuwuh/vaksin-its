...
<div class="row row-xs">
    <div class="col-sm-12 col-lg-12 mg-b-10">
        <div class="card">
          <div class="card-body">
            <form action="{{ route('jadwal-vaksinasi.store') }}" method="POST">
                @csrf
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-6">
                    ...
                    <input type="date" id="pendaftaran_mulai" name="pendaftaran_mulai" class="form-control" required>
                  </div>
                  <div class="col-6">
                    <label class="d-block tx-10 tx-spacing-1 tx-color-03 tx-uppercase tx-semibold">Pendaftaran selesai</label>
                    <input type="date" id="pendaftaran_selesai" name="pendaftaran_selesai" class="form-control" required>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="date" id="pelaksanaan" name="pelaksanaan" class="form-control" required>
              </div>
              <div class="form-group">
                <div class="row">
                  <div class="col-6">
